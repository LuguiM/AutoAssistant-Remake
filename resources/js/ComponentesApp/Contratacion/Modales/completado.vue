<template>
    <v-dialog v-model="dialog" persistent width="auto">
       <template v-slot:activator="{ props }">
           ...
           <v-btn v-else-if="prop.type === 'icon'" v-bind="props" variant="flat" density="compact" icon="mdi-wrench-check-outline"></v-btn>
       </template>
           ...
           <v-card class="text-center bg-greyDark">
               ...
               <v-card-text class="text-h4"><v-icon color="success">mdi-wrench-check-outline</v-icon></v-card-text>
               ...
               <v-card-actions class="mt-3">
                   <v-btn class="bg-primary" @click="completarServicio">Confimar</v-btn>
                   <v-spacer></v-spacer>
